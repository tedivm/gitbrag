...
- Installed with `pip install gitbrag`
...
- Installed with `pip install gitbrag[dev]`
...
# Creates:
# dist/gitbrag-X.Y.Z.tar.gz (source)
# dist/gitbrag-X.Y.Z-py3-none-any.whl (wheel)
```
