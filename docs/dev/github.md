...
**lockfiles.yaml** - Automated Dependency Updates

- **Trigger**: Weekly schedule (Mondays) and manual dispatch
- **Purpose**: Updates uv.lock with latest compatible dependencies and creates PR
- **Command**: `uv lock --upgrade`
- **Automation**: Creates pull request with updated lockfile for review
...
- **Images**:
  - `ghcr.io/tedivm/gitbrag.www` - FastAPI web server
...
python -c "from gitbrag._version import version; print(version)"
...
docker pull ghcr.io/tedivm/gitbrag.www:latest
```
...
docker pull ghcr.io/tedivm/gitbrag.www:main

# Pull specific version
docker pull ghcr.io/tedivm/gitbrag.www:v1.2.3

# Use in docker-compose
services:
  www:
    image: ghcr.io/tedivm/gitbrag.www:v1.2.3
```
