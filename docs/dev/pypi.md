...
[project]
name = "gitbrag"
description = "Create a brag list of open source contributions"
...
ls dist/
# gitbrag-1.2.3.tar.gz
# gitbrag-1.2.3-py3-none-any.whl
```
...
# Install from wheel
pip install dist/gitbrag-*.whl

# Verify installation
python -c "import gitbrag; print(gitbrag.__version__)"
...
1. Go to your project page: `https://pypi.org/project/gitbrag/`
...
```bash
# View on PyPI
open https://pypi.org/project/gitbrag/
