...
async def user_report(
    ...
    context = {
        ...
        "total_additions": report_data.get("total_additions"),
        "total_deletions": report_data.get("total_deletions"),
        "total_changed_files": report_data.get("total_changed_files"),
        "language_breakdown": report_data.get("language_breakdown", []),
        "repo_roles": report_data.get("repo_roles", {}),
        "size_distribution": report_data.get("size_distribution", {}),
