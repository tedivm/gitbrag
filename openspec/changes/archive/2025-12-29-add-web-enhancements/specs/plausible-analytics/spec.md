# Plausible Analytics Spec Delta
...
- **web-user-interface**: This change adds analytics capability to the existing web interface without modifying core functionality
