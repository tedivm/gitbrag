# Empty State Messaging Spec Delta
...
- Extends `web-user-interface` spec (user report display)
- Extends `contribution-report-cli` spec (applies only to web interface, not CLI)
